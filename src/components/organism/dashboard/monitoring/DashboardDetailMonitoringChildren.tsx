...
interface DashboardDetailMonitoringChildrenProps {
  id: string;
}

export default function DashboardDetailMonitoringChildrenWrapper({
  id,
}: DashboardDetailMonitoringChildrenProps) {
