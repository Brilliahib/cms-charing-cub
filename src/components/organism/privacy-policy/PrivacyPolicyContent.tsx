  ...
  return (
    <div className="pad-x-xl mt-8">
      <div className="space-y-6 leading-loose">
        <SectionTitle title="Kebijakan Privasi" subtitle="" />
        <div>
        ...
        <div>
          <p className="mb-4">
            ...
            saat Anda menggunakan Layanan dan memberitahu Anda tentang hak
            privasi Anda serta bagaimana hukum melindungi Anda.
          </p>
          <p className="mb-4">
            Kami menggunakan Data Pribadi Anda untuk menyediakan dan
            meningkatkan Layanan. Dengan menggunakan Layanan, Anda setuju dengan
            pengumpulan dan penggunaan informasi sesuai dengan Kebijakan Privasi
            ini. Kebijakan Privasi ini dibuat dengan bantuan{" "}
            <Link
        ...
        <div>
          ...
          <h3 className="text-xl font-bold mt-4 mb-2">Interpretasi</h3>
          <p className="mb-4">
            Kata-kata yang huruf awalnya dikapitalisasi memiliki arti yang
            didefinisikan di bawah kondisi berikut. Definisi-definisi berikut
            memiliki arti yang sama, baik dalam bentuk tunggal maupun jamak.
          </p>
          <h3 className="text-xl font-bold mt-4 mb-2">Definisi</h3>
          <p className="mb-4">Untuk tujuan Kebijakan Privasi ini:</p>
          <ul className="list-disc pl-8 space-y-4">
            <li>
              <p>
                <strong>Akun</strong> berarti akun unik yang dibuat untuk Anda
                mengakses Layanan kami atau bagian dari Layanan kami.
              </p>
            </li>
            <li>
              <p>
                ...
                atau lebih saham, kepentingan ekuitas, atau surat berharga
                lainnya yang berhak memberikan suara untuk pemilihan direksi
            ...
            <li>
              <p>
                ...
                &quot;Perusahaan&quot;, &quot;Kami&quot;, &quot;Kami&quot;, atau
                &quot;Milik Kami&quot; dalam Perjanjian ini) merujuk pada
                Charing Cub.
              </p>
            </li>
            <li>
              <p>
                <strong>Cookies</strong> adalah file kecil yang ditempatkan di
                komputer, perangkat seluler, atau perangkat lain Anda oleh situs
                web, yang berisi detail riwayat penjelajahan Anda di situs web
                tersebut di antara banyak kegunaannya.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                menyediakan Layanan atas nama Perusahaan, melakukan layanan yang
                terkait dengan Layanan, atau membantu Perusahaan dalam
            ...
            <li>
              <p>
                ...
                menggunakan Layanan, atau perusahaan, atau badan hukum lainnya
                yang atas nama individu tersebut mengakses atau menggunakan
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            identitas pribadi mungkin termasuk, tetapi tidak terbatas pada:
          </p>
          <ul className="list-disc pl-8 space-y-4">
            <li>
              <p>Alamat email</p>
          ...
          <p className="mb-4">
            Data Penggunaan mungkin termasuk informasi seperti alamat Protokol
            Internet (IP) Perangkat Anda, jenis browser, versi browser, halaman
            Layanan kami yang Anda kunjungi, waktu dan tanggal kunjungan Anda,
            waktu yang dihabiskan di halaman tersebut, pengidentifikasi
            perangkat unik, dan data diagnostik lainnya.
          </p>
          <p className="mb-4">
            Saat Anda mengakses Layanan melalui atau melalui perangkat seluler,
            Kami mungkin mengumpulkan informasi tertentu secara otomatis,
            termasuk, tetapi tidak terbatas pada, jenis perangkat seluler yang
            Anda gunakan, ID unik perangkat seluler Anda, alamat IP perangkat
            seluler Anda, sistem operasi seluler Anda, jenis browser Internet
            seluler yang Anda gunakan, pengidentifikasi perangkat unik, dan data
            diagnostik lainnya.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            untuk mengumpulkan dan melacak informasi serta untuk meningkatkan
            dan menganalisis Layanan Kami. Teknologi yang Kami gunakan mungkin
            termasuk:
          </p>
          <ul className="list-disc pl-8 space-y-4 mb-6">
            <li>
              <strong>Cookies atau Browser Cookies.</strong> Cookie adalah file
              kecil yang ditempatkan di Perangkat Anda. Anda dapat
              ...
              menerima Cookies, Anda mungkin tidak dapat menggunakan beberapa
              bagian dari Layanan kami. Kecuali Anda telah menyesuaikan
              pengaturan browser Anda sehingga akan menolak Cookies, Layanan
              kami mungkin menggunakan Cookies.
            </li>
            <li>
              <strong>Web Beacons.</strong> Bagian tertentu dari Layanan kami
              dan email kami mungkin mengandung file elektronik kecil yang
              dikenal sebagai web beacon (juga disebut sebagai gif jernih, tag
              piksel, dan gif satu piksel) yang memungkinkan Perusahaan,
              ...
              lainnya (misalnya, merekam popularitas bagian tertentu dan
              memverifikasi integritas sistem dan server).
            </li>
          </ul>
          <p className="mb-4">
            Cookies dapat berupa &quot;Persisten&quot; atau &quot;Sesi&quot;.
            Cookies Persisten tetap ada di komputer pribadi atau perangkat
            seluler Anda saat Anda offline, sementara Cookies Sesi dihapus
            segera setelah Anda menutup browser web Anda. Anda dapat mempelajari
            lebih lanjut tentang cookies di artikel{" "}
            <Link
          ...
          <p className="mb-4">
            Kami menggunakan kedua jenis Cookies, baik Sesi maupun Persisten,
            untuk tujuan yang dijelaskan di bawah ini:
          </p>
          <ul className="list-disc pl-8 mb-6 space-y-4">
            <li>
              ...
              <p>
                Tujuan: Cookies ini esensial untuk menyediakan Anda layanan yang
                tersedia melalui Situs Web dan untuk memungkinkan Anda
                menggunakan beberapa fiturnya. Mereka membantu mengautentikasi
                pengguna dan mencegah penggunaan curang akun pengguna. Tanpa
                Cookies ini, layanan yang Anda minta tidak dapat disediakan, dan
                Kami hanya menggunakan Cookies ini untuk menyediakan Anda
                layanan tersebut.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>Dikelola oleh: Kami</p>
              <p>
                Tujuan: Cookies ini memungkinkan kami untuk mengingat pilihan
                yang Anda buat saat menggunakan Situs Web, seperti mengingat
                detail login atau preferensi bahasa Anda. Tujuan Cookies ini
                adalah untuk memberikan Anda pengalaman yang lebih personal dan
                menghindari Anda harus memasukkan preferensi Anda setiap kali
                Anda menggunakan Situs Web.
              </p>
            </li>
          </ul>
          <p className="mb-4">
            Untuk informasi lebih lanjut tentang cookies yang kami gunakan dan
            pilihan Anda terkait cookies, silakan kunjungi Kebijakan Cookies
            kami atau bagian Cookies dari Kebijakan Privasi kami.
          </p>
          ...
          <ul className="list-disc pl-8 mb-6 space-y-4">
            ...
            <li>
              <p>
                ...
                Anda berikan dapat memberi Anda akses ke berbagai fungsi Layanan
                yang tersedia untuk Anda sebagai pengguna terdaftar.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Untuk menghubungi Anda:</strong> Untuk menghubungi Anda
                melalui email, panggilan telepon, SMS, atau bentuk komunikasi
                elektronik setara lainnya, seperti pemberitahuan push aplikasi
                seluler mengenai pembaruan atau komunikasi informatif yang
                terkait dengan fungsi, produk, atau layanan yang dikontrak,
                termasuk pembaruan keamanan, ketika diperlukan atau wajar untuk
                implementasinya.
              </p>
            </li>
            <li>
              <p>
                ...
                khusus, dan informasi umum tentang barang, layanan, dan acara
                lain yang kami tawarkan yang serupa dengan yang telah Anda beli
                atau tanyakan, kecuali Anda telah memilih untuk tidak menerima
                informasi tersebut.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                penjualan atau transfer lainnya dari sebagian atau seluruh aset
                Kami, baik sebagai kelangsungan usaha atau sebagai bagian dari
                kebangkrutan, likuidasi, atau proses serupa, di mana Data
                Pribadi yang dimiliki oleh Kami tentang pengguna Layanan kami
            ...
            <li>
              <p>
                ...
                kampanye promosi kami, dan untuk mengevaluasi dan meningkatkan
          ...
          <ul className="list-disc pl-8 mb-6 space-y-4">
            <li>
              ...
              informasi pribadi Anda dengan Penyedia Layanan untuk memantau dan
              menganalisis penggunaan Layanan kami, untuk menghubungi Anda.
            </li>
            <li>
              <strong>Untuk transfer bisnis:</strong> Kami dapat membagikan atau
              mentransfer informasi pribadi Anda sehubungan dengan, atau selama
              negosiasi, merger, penjualan aset Perusahaan, pembiayaan, atau
              akuisisi seluruh atau sebagian bisnis Kami ke perusahaan lain.
            </li>
            <li>
              <strong>Dengan Afiliasi:</strong> Kami dapat membagikan informasi
              Anda dengan Afiliasi Kami, dalam hal ini kami akan meminta
              Afiliasi tersebut untuk menghormati Kebijakan Privasi ini.
              Afiliasi termasuk perusahaan induk Kami dan setiap anak
              perusahaan, mitra usaha patungan, atau perusahaan lain yang Kami
            ...
            <li>
              ...
              informasi pribadi atau berinteraksi di area publik dengan pengguna
              lain, informasi tersebut dapat dilihat oleh semua pengguna dan
              dapat didistribusikan secara publik di luar.
            </li>
            <li>
          ...
          <p className="mb-4">
            ...
            untuk tujuan yang dijelaskan dalam Kebijakan Privasi ini. Kami akan
            ...
            menyimpan data Anda untuk mematuhi hukum yang berlaku),
            menyelesaikan sengketa, dan menegakkan perjanjian dan kebijakan
            hukum kami.
          </p>
          <p className="mb-4">
            Perusahaan juga akan menyimpan Data Penggunaan untuk tujuan analisis
            internal. Data Penggunaan umumnya disimpan untuk periode waktu yang
            lebih singkat, kecuali ketika data ini digunakan untuk memperkuat
            keamanan atau meningkatkan fungsionalitas Layanan kami, atau Kami
            diwajibkan secara hukum untuk menyimpan data ini untuk periode waktu
            yang lebih lama.
          </p>
          ...
          <p className="mb-4">
            ...
            operasional Perusahaan dan di tempat lain di mana pihak-pihak yang
            terlibat dalam pemrosesan berada. Ini berarti bahwa informasi ini
            dapat ditransfer ke — dan disimpan di — komputer yang berada di luar
            negara, provinsi, negara bagian, atau yurisdiksi pemerintah Anda di
            mana undang-undang perlindungan data mungkin berbeda dari yurisdiksi
            Anda.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            dengan Kebijakan Privasi ini dan tidak ada transfer Data Pribadi
            Anda yang akan dilakukan ke organisasi atau negara kecuali ada
            kontrol yang memadai termasuk keamanan data dan informasi pribadi
            Anda.
          </p>
          ...
          <p className="mb-4">
            ...
            informasi tertentu ketika kami memiliki kewajiban hukum atau dasar
          ...
          <p className="mb-4">
            ...
            yang tulus bahwa tindakan tersebut diperlukan untuk:
          </p>
          <ul className="list-disc pl-8 mb-6 space-y-4">
            <li>Mematuhi kewajiban hukum</li>
            <li>Melindungi dan mempertahankan hak atau properti Perusahaan</li>
            <li>
              Mencegah atau menyelidiki kemungkinan pelanggaran dalam kaitannya
              dengan Layanan
            </li>
        ...
        <div>
          <h2 className="text-2xl font-bold mt-6 mb-4">Privasi Anak-Anak</h2>
          <p className="mb-4">
            Layanan kami tidak ditujukan untuk siapa pun di bawah usia 13 tahun.
            Kami tidak secara sadar mengumpulkan informasi identitas pribadi
            dari siapa pun di bawah usia 13 tahun. Jika Anda adalah orang tua
            atau wali dan Anda menyadari bahwa anak Anda telah memberikan Kami
            Data Pribadi, silakan hubungi Kami. Jika Kami menyadari bahwa Kami
            telah mengumpulkan Data Pribadi dari siapa pun di bawah usia 13
            tahun tanpa verifikasi persetujuan orang tua, Kami mengambil
          ...
          <p className="mb-4">
            ...
            memproses informasi Anda dan negara Anda memerlukan persetujuan dari
            orang tua, Kami mungkin memerlukan persetujuan orang tua sebelum
        ...
        <div>
          ...
          <p className="mb-4">
            Layanan kami mungkin mengandung tautan ke situs web lain yang tidak
        ...
        <div>
          <h2 className="text-2xl font-bold mt-6 mb-4">Hubungi Kami</h2>
          <p className="mb-4">
