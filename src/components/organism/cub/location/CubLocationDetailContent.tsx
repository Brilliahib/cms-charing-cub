    ...
    <div className="mx-auto px-4 max-w-[1400px]">
      <div className="space-y-4 md:space-y-12">
              ...
              <div className="space-y-4 md:block flex">
                {data?.data.facility_images?.map((facilityImage) => (
                  <Image
                    ...
                    onClick={() => handleImageClick(facilityImage.image_url)}
                  />
                ))}
              </div>
            </ScrollArea>
        ...
        <div className="space-y-4">
          <div>
            <h1 className="font-bold md:text-3xl text-xl">{data?.data.name}</h1>
          </div>
        ...
        <div className="md:flex gap-4 md:gap-12">
          <div className="space-y-4 md:space-y-8 w-8/12">
              ...
              <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
                {data?.data.nannies ? (
                  data?.data.nannies.map((nannies) => (
                    <Card className="bg-secondary border-0" key={nannies.id}>
